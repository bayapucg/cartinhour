        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
              <li><a href="<?php echo base_url();?>seller/login">HOME <span class="sr-only">(current)</span></a></li>
              ...
              <li class="active"><a href="<?php echo base_url();?>seller/pricing_calculator">PRICINGS</a></li>
