        ...
        <div class="col-lg-12">
          <section class="panel">
            ...
            <div class="panel-body">
              ...
              <form action="<?php echo base_url(); ?>seller/personnel_details/updatedisplaydetails" method="post" enctype="multipart/form-data" onSubmit="return scvalidateof();">
        ...
        <div class="col-lg-12">
          <section class="panel">
            ...
            <div class="panel-body">
              ...
              <form action="<?php echo base_url(); ?>seller/personnel_details/updatebusinessdetails" method="post" enctype="multipart/form-data">
        ...
        <div class="col-lg-12">
          <section class="panel">
            ...
            <div class="panel-body">
              ...
              <form action="<?php echo base_url(); ?>seller/personnel_details/updatebankdetails" method="post" enctype="multipart/form-data">
